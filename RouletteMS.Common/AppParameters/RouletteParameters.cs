...
namespace RouletteMS.Common.AppParameters
{
    public static class RouletteParameters
    {
        ...
        public static readonly int ROULETTE_MAX_NUMBER = int.Parse(Environment.GetEnvironmentVariable("ROULETTE_MAX_NUMBER"));
        public static readonly int ROULETTE_MIN_NUMBER = int.Parse(Environment.GetEnvironmentVariable("ROULETTE_MIN_NUMBER"));
    }
}
